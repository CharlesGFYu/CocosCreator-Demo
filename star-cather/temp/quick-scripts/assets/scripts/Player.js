...
cc._RF.push(module, 'd2f2axftFFHcLkZ25rTs9K2', 'Player', __filename);
// scripts/Player.js
...
cc.Class({
    ...
    playJumpSound: function playJumpSound() {
        // 调用声音引擎播放声音
        var audio = cc.audioEngine.playEffect(this.jumpAudio, false);
        console.log('audio', audio, this.jumpAudio);
    },
